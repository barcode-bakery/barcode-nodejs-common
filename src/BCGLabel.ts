...
class BCGLabel {
    private font: BCGFont = new BCGFont('Arial', 12);
    private text: string = '';
    private position: BCGLabel.Position = BCGLabel.Position.Bottom;
    private alignment: BCGLabel.Alignment = BCGLabel.Alignment.Center;
    private offset: number = 0;
    private spacing: number = 4;
    private rotationAngle: number = 0;
    private backgroundColor: BCGColor = new BCGColor(0xffffff);
    private foregroundColor: BCGColor = new BCGColor(0x000000);
     ...
     */
    constructor(text: string = '', font: BCGFont | null = null, position: BCGLabel.Position = BCGLabel.Position.Bottom, alignment: BCGLabel.Alignment = BCGLabel.Alignment.Center) {
        if (font != null) {
            this.setFont(font);
        }
    ...
    setPosition(position: BCGLabel.Position): void {
        if (position !== BCGLabel.Position.Top && position !== BCGLabel.Position.Right && position !== BCGLabel.Position.Bottom && position !== BCGLabel.Position.Left) {
    ...
    setAlignment(alignment: BCGLabel.Alignment): void {
        if (alignment !== BCGLabel.Alignment.Left && alignment !== BCGLabel.Alignment.Top && alignment !== BCGLabel.Alignment.Center && alignment !== BCGLabel.Alignment.Right && alignment !== BCGLabel.Alignment.Bottom) {
    ...
    getDimension(): [number, number] {
        ...
        let dimension = this.font.getDimension();
        w = dimension[0];
        h = dimension[1];
    ...
    draw(image: Surface, x1: number, y1: number, x2: number, y2: number): void {
        ...
        let fontDimension = this.font.getDimension();
