...
class BCGColor {
    ...
    constructor(arg0?: number | string, arg1?: number, arg2?: number) {
        if (typeof arg0 === 'number' && arg1 !== undefined && arg2 !== undefined) {
            ...
            if (typeof arg0 === 'string' && arg0.length === 7 && arg0[0] === '#') { // Hex Value in String
                this.vR = parseInt(arg0.substr(1, 2), 16);
                this.vG = parseInt(arg0.substr(3, 2), 16);
                this.vB = parseInt(arg0.substr(5, 2), 16);
            } else {
    ...
    allocate(image: Surface): { r: number, g: number, b: number } {
        let allocated = imagecolorallocate(image, this.vR, this.vG, this.vB);
        if (this.transparent) {
