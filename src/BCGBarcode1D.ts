...
abstract class BCGBarcode1D extends BCGBarcode {
     ...
     * The font.
     */
    protected font: BCGFont = new BCGFont('Arial', 8);
     ...
     */
    protected displayChecksum: boolean = false;
     ...
     */
    protected drawChar(image: Surface, code: string, startBar: boolean = true): void {
        let colors = [BCGBarcode.COLOR_FG, BCGBarcode.COLOR_BG];
